...
| [node-common-library](packages/node-common-library) | 4.0.0 | The four-tier data layer — `CommonDAO` / `CommonRepository` / `CommonService`, `@Transaction`, `BeanFactory`, `CommonSearchCriteria`, pagination |
| [bean-validator](packages/bean-validator) | 1.0.2 | Declarative DTO validation and sanitisation |
| [node-exception](packages/node-exception) | 2.0.0 | Standardised Express error handling middleware |
...
| [dm-common-library](packages/dm-common-library) | 3.3.0 | Dameng (DM8) |
