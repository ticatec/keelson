...
## How this relates to ai-prompts guides

`ai-prompts/` holds the **reference guides** — every method, every option, every edge
...
If you drive an AI assistant, `ai-prompts/README.md` has the layer rules as a block to
