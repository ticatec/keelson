...
This package was `@ticatec/node-common-library`. It is now **`@ticatec/keelson-core`**, and the
...
`@ticatec/node-common-library@3.2.5`; the work that had accumulated
locally as 4.1.0 ships here as 1.0.0.

To migrate, change the dependency and the import specifier - nothing else:

```diff
-"@ticatec/node-common-library": "^3.2.5"
+"@ticatec/keelson-core": "^1.0.0"
```

```diff
-import { ... } from '@ticatec/node-common-library';
+import { ... } from '@ticatec/keelson-core';
```
