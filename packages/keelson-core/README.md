...
- **Multi-database Support**: adapt to any database by implementing the `DBConnection` abstract class and the `DBFactory` interface (ready-made drivers: `@ticatec/keelson-pg`, `@ticatec/keelson-mysql`, `@ticatec/keelson-dm`)
...
```bash
pnpm add @ticatec/keelson-core @ticatec/logger-api reflect-metadata
...
```typescript
// ESM / TypeScript
import { DBManager, beanFactory, CommonService, CommonDAO } from '@ticatec/keelson-core';

// CommonJS
const { DBManager, beanFactory, CommonService, CommonDAO } = require('@ticatec/keelson-core');
```
...
import type { InsertResult } from '@ticatec/keelson-core';
...
import type { PaginationList } from '@ticatec/keelson-core';
...
```typescript
import { beanFactory, BeanFactory } from '@ticatec/keelson-core';
...
```typescript
import { DBConnection, DBFactory, Field, FieldType } from '@ticatec/keelson-core';
import type { InsertResult, UpdateResult } from '@ticatec/keelson-core';
...
```typescript
import type { BatchRecord, BatchRecords } from '@ticatec/keelson-core';
...
```typescript
import { BitsBoolean } from '@ticatec/keelson-core';
...
```typescript
import { StringUtils } from '@ticatec/keelson-core';
...
```typescript
import { getLogger } from '@ticatec/keelson-core';
import type { Logger } from '@ticatec/keelson-core';
...
```typescript
import { getLogger, sqlContext } from '@ticatec/keelson-core';
...
```typescript
import { OptimisticLockException } from '@ticatec/keelson-core';
