...
This document explains dependency management in `@ticatec/node-common-library` v4 — `beanFactory` for registration and lookup, and `Beans` for deferred module loading.
