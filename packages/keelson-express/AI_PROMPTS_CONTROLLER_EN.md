...
This document provides detailed prompts for AI-assisted programming to help developers understand and use the Controller class hierarchy from the `@ticatec/keelson-express` framework.
...
```
Please help me register a server-wide custom user model for @ticatec/keelson-express in my TypeScript project. Requirements:
...
2. Define interface AppUser extending LoggedUser with properties:
   ...
   - permissions: string[]
   - departmentId: string
3. Use declare module '@ticatec/keelson-express' for TypeScript declaration merging
