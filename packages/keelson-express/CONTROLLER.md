...
This guide explains how to use the controller classes provided by `@ticatec/keelson-express` to build your API endpoints.
...
```typescript
import BaseController from '@ticatec/keelson-express/common/BaseController';
...
```typescript
import CommonController from '@ticatec/keelson-express/common/CommonController';
...
```typescript
import CommonSearchController from '@ticatec/keelson-express/common/CommonSearchController';
import { Request } from 'express';
